    ...
    <header className="absolute left-0 right-0 top-0 z-40 border-b border-[#5b4747]/10">
      <div className="mx-auto flex h-[76px] max-w-[1320px] items-center justify-between px-5 lg:px-10">
        ...
        <nav className="hidden items-center gap-9 text-[12px] font-medium uppercase tracking-[.16em] text-[#fffaf5]/80 md:flex">
          <button onClick={() => go('studio')} className="transition hover:text-white" data-testid="link-try-on">Virtual try-on</button>
          <button onClick={() => go('story')} className="transition hover:text-white" data-testid="link-our-story">Our philosophy</button>
          <button onClick={() => go('trust')} className="transition hover:text-white" data-testid="link-trust">The Lustra standard</button>
        </nav>
    ...
    <section className="relative min-h-[720px] overflow-hidden bg-[#4a3538] text-[#fffaf5] lg:min-h-[790px]">
      ...
      <div className="relative mx-auto grid max-w-[1320px] items-center gap-12 px-5 pb-20 pt-36 lg:grid-cols-[1.05fr_.95fr] lg:px-10 lg:pb-24 lg:pt-48">
        <div className="relative z-10 max-w-[700px]">
          ...
          <h1 className="reveal reveal-delay-1 font-editorial text-[clamp(4.2rem,9vw,8.5rem)] leading-[.88] tracking-[-.06em]">Meet the hair<br /><em className="text-[#efc9c0]">you've imagined.</em></h1>
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
      ...
      <aside className="rounded-[1.6rem] border border-[#e3d5cf] bg-[#fcfaf7] p-6 sm:p-7">
        <p className="text-[10px] font-semibold uppercase tracking-[.18em] text-[#b66f78]">The edit</p><h3 className="mt-3 font-editorial text-3xl text-[#493538]" data-testid="text-result-style">{look.name}</h3><p className="mt-1 text-sm text-[#806e69]">{colour} · 100% human hair</p>
